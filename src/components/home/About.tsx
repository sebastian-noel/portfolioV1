    ...
    <section className="bg-background text-foreground py-12">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="space-y-6 text-lg leading-relaxed text-(--color-text)/85">
          ...
          <p>
            I&apos;m currently a Software Engineer Intern at <a href="https://www.bny.com/" target="_blank" rel="noopener noreferrer" className="relative text-accent font-semibold after:content-[''] after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-0.5 after:bg-primary after:transition-all after:duration-300 hover:after:w-full">BNY</a>, Computer Vision Researcher at <a href="https://www.crcv.ucf.edu/" target="_blank" rel="noopener noreferrer" className="relative text-accent font-semibold after:content-[''] after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-0.5 after:bg-primary after:transition-all after:duration-300 hover:after:w-full">CRCV</a>, Secretary & Software Engineer at <a href="https://knightconnect.campuslabs.com/engage/organization/graphicsprogrammingknights" target="_blank" rel="noopener noreferrer" className="relative text-accent font-semibold after:content-[''] after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-0.5 after:bg-primary after:transition-all after:duration-300 hover:after:w-full">Graphics Programming Knights</a>, and an Outreach Board Member for <a href="https://club.knighthacks.org/" target="_blank" rel="noopener noreferrer" className="relative text-accent font-semibold after:content-[''] after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-0.5 after:bg-primary after:transition-all after:duration-300 hover:after:w-full">Knight Hacks</a>!
          </p>
